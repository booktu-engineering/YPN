...
class AddCommentContainer extends Component {
    ...
    handleSubmit = () => {
        ...
        const data = { type: 1, content: this.state.content, referenceObject: this.props.target, referenceID: this.props.target._id }
           ...
           <KeyboardAvoidingView enabled behavior="padding" style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                    <View style={{
                        ...
                        <View style={{flexDirection: 'row', alignItems: 'center'}}>
                           ...
                           <Text style={{marginHorizontal: 10, fontWeight: '500', fontSize: 13 }}>{this.props.target.origin.firstname}</Text>
                        </View>
                        <TextInput 
                        ...
                        />
                        <TouchableOpacity onPress={this.handleSubmit}style={{backgroundColor: '#82BE30', width: '20%', paddingVertical: 10,paddingHorizontal: 5, alignSelf: 'flex-end', borderRadius: 4}}>
