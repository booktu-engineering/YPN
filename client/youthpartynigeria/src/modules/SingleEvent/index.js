...
const SingleEvent = ({ obj, data }) => (
  <TouchableOpacity style={{ height: height * 0.16, flexDirection: 'row', flexWrap: 'nowrap', justifyContent: 'space-around', alignItems: 'center', borderBottomWidth: 1, borderBottomColor: '#F8F9F9' }}
    ...
    <TouchableWithoutFeedback onPress={() => { obj.dispatch(fetchSpecificEvent(data._id)(obj.navigator)) }} style={{ backgroundColor: defaultGreen, height: height * 0.028, width: width * 0.12, borderRadius: 2, position: 'relative', bottom: height * 0.023, justifyContent: 'center', alignItems: 'center' }}>
