...
const LandingComponent = ({ navigator }) => (
  <View style={styles.base}>
    ...
    {/* end of button stack */}
    <Text style={{ color: '#2F2E2E', textAlign: 'center', width: width * 0.6, position: 'absolute', bottom: 70 }}> By signing up, you agree to our <Text style={{ color: '#82BE30' }} onPress={() => navigator.showModal({ screen: 'Web.Page', title: 'Privacy Policy', passProps: { source: 'https://youthpartyng.com/wp-content/uploads/2015/10/Privacy-Policy-for-Youth-Party2.pdf '}})}>Privacy Policy</Text> & <Text onPress={() => navigator.showModal({ screen: 'Web.Page', title: 'Terms of Service', passProps: { source: 'https://youthpartyng.com/wp-content/uploads/2015/10/YP-MOBILE-APP-TERMS-AND-CONDITIONS.pdf'}})} style={{ color: '#82BE30'}}>Terms of Service</Text></Text>
  </View>
);
